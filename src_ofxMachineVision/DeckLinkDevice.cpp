...
namespace ofxMachineVision {
	namespace Device {
		...
		//----------
		void DeckLinkDevice::setDisplayMode(_BMDDisplayMode displayMode) {
			this->displayMode = displayMode;
		}

		//----------
		_BMDDisplayMode DeckLinkDevice::getDisplayMode() const {
			return this->displayMode;
		}

		//----------
		Specification DeckLinkDevice::open(int deviceID) {
		...
		//---------
		HRESULT DeckLinkDevice::VideoInputFormatChanged(BMDVideoInputFormatChangedEvents, IDeckLinkDisplayMode* displayMode, BMDDetectedVideoInputFormatFlags) {
			return S_OK;
		}

		//---------
		HRESULT DeckLinkDevice::VideoInputFrameArrived(IDeckLinkVideoInputFrame* videoFrame, IDeckLinkAudioInputPacket* audioFrame) {
			if (videoFrame == NULL) {
				return S_OK;
			}
